...
-- FLAT
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '31 Hz', 0.0 FROM eq_presets WHERE name='flat';
...
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '16 kHz', 0.0 FROM eq_presets WHERE name='flat';

-- BASS BOOST
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '31 Hz', 6.0 FROM eq_presets WHERE name='bass_boost';
...
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '16 kHz', 0.0 FROM eq_presets WHERE name='bass_boost';

-- LOUDNESS
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '31 Hz', 5.0 FROM eq_presets WHERE name='loudness';
...
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '16 kHz', 5.0 FROM eq_presets WHERE name='loudness';

-- ELECTRONIC
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '31 Hz', 6.0 FROM eq_presets WHERE name='electronic';
...
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '16 kHz', 6.0 FROM eq_presets WHERE name='electronic';

-- WARM VINTAGE
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '31 Hz', 3.0 FROM eq_presets WHERE name='warm_vintage';
...
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '16 kHz', 2.0 FROM eq_presets WHERE name='warm_vintage';

-- VOCAL CLARITY
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '31 Hz', -2.0 FROM eq_presets WHERE name='vocal_clarity';
...
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '16 kHz', 0.0 FROM eq_presets WHERE name='vocal_clarity';

-- CINEMATIC
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '31 Hz', 5.0 FROM eq_presets WHERE name='cinematic';
...
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '16 kHz', 6.0 FROM eq_presets WHERE name='cinematic';

-- BRIGHT CRISP
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '31 Hz', -1.0 FROM eq_presets WHERE name='bright_crisp';
...
INSERT INTO eq_preset_bands (preset_id, frequency, gain_db) SELECT id, '16 kHz', 6.0 FROM eq_presets WHERE name='bright_crisp';
