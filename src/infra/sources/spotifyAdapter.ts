...
export class SpotifySourceAdapter implements AudioSourceAdapter {
  ...
  async search(query: string): Promise<MediaItem[]> {
    const raw: any = await this.api.search(query, ["track", "album", "show", "episode", "playlist"])
