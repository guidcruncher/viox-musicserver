...
export interface PlaylistStore {
  ...
  listPaged(limit: number, offset: number): Promise<MediaItem[]>
  listPlaylist(): Promise<Playlist[]>
  listPlaylistPaged(offset: number, limit: number): Promise<Playlist[]>
  ...
  // Ordering
  reorderItem(playlistId: string, itemId: string, newPosition: number): Promise<void>
